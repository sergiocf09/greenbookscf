-- Update function to allow service role execution for administrative purposes
...
-- Execute the rebuild immediately
SELECT public.rebuild_all_pvp_from_snapshots();