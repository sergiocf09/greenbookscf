...
<tr><td style="background:linear-gradient(135deg,#0f4c2a 0%%,#0a2d18 50%%,#061a0e 100%%);padding:32px 24px 24px;border-radius:16px 16px 0 0;text-align:center;">
<img src="https://golfgreenbookscf.com/greenbook-icon-circle-dark.png" alt="GreenBook" width="96" height="96" style="display:block;margin:0 auto 8px;border:0;outline:none;text-decoration:none;background:transparent;" />
<div style="font-family:Georgia,'Times New Roman',serif;font-style:italic;font-size:26px;font-weight:700;color:#facc15;letter-spacing:0.5px;margin-bottom:18px;">GreenBook</div>
<div style="font-size:20px;font-weight:800;color:#f8fafc;margin-bottom:4px;">Resumen de Ronda</div>
