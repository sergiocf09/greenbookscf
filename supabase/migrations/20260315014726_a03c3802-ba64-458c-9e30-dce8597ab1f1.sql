DO $$
DECLARE
  v_old uuid := '01f284d7-b4f2-4be1-aeb0-e1556d1c6425';
  v_target uuid := 'dc1e017a-5bb7-4cf6-8d2a-fc83b9044d2a';
  v_mar9_rp uuid := '6359c904-6df4-4560-b690-d32b957e1e5f';
...
BEGIN
  ...
  -- STEP 2: Reassign round_players (Jan 14, Jan 21, Feb 1)
  ...
  -- STEP 4: Update snapshot JSON (Jan 14, Jan 21, Feb 1)
  ...
  SET snapshot_json = (
    regexp_replace(
      regexp_replace(
        ...
        '"initials":\s*"AL"', '"initials": "AS"', 'g'
      ),
      '"avatar_color":\s*"#04849f"', '"avatar_color": "#83a899"', 'g'
    )
  )::jsonb
  WHERE round_id IN ('f812811c-4c86-4957-8c1f-7a11133c0967','4757d879-3414-4c78-b43a-6e49971196fc','f08414dc-9f77-49e7-b88c-0891e339d1ab');
  ...
  -- STEP 8: Clean up auxiliary tables
