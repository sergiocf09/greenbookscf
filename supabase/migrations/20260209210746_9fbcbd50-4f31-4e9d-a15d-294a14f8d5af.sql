...
BEGIN
  ...
  LOOP
    ...
    LOOP
      p_profile_text := player_elem->>'profileId';
      total_net := 0;
      vs_balances_arr := '[]'::jsonb;
      ...
      LOOP
        ...
        r_profile_text := rival_elem->>'profileId';
        
        IF p_profile_text IS NULL OR r_profile_text IS NULL THEN
        ...
        p_profile_id := p_profile_text::uuid;
        r_profile_id := r_profile_text::uuid;
