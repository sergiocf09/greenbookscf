...
-- Fix delete_round_with_financials to clear ALL player_vs_player.last_round_id references FIRST
...
BEGIN
  ...
  -- CRITICAL FIX: Clear ALL player_vs_player.last_round_id references to this round FIRST
  -- This prevents FK constraint violations when deleting the round
  ...
  -- Delete sliding_current that references this round
  UPDATE public.sliding_current SET last_round_id = NULL WHERE last_round_id = p_round_id;
