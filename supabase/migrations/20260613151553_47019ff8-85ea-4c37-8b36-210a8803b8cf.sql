...
-- Update paywall date to 2026-07-09 06:00 UTC (midnight CST Mexico)
...
DECLARE
  ...
  v_count int;
  v_paywall_date timestamptz := '2026-07-09T06:00:00Z';
BEGIN
...
AS $function$
  SELECT (
    NOW() < TIMESTAMPTZ '2026-07-09T00:00:00-06:00'
    OR (
