...
const helpContent: Record<string, { icon: React.ReactNode; title: string; items: string[] }> = {
  ...
  betsetup: {
    ...
    items: [
      ...
      'PAREJAS — entre equipos de 2 vs 2: Carritos (lowball, highball o combined), Presiones Parejas, Wolf (el lobo elige compañero o va solo cada hoyo), Sixes (rotación de parejas cada 6 hoyos) y Las Vegas (puntaje combinado de parejas tipo dado).',
      'GRUPALES — un ganador entre todos: Medal General (menor neto total), Stableford (puntos por hoyo), Culebras (último en tener 3+ putts paga a todos), Pingüinos (último en tener triple bogey paga a todos), Zoológico, Putts, Nines (9 puntos por hoyo repartidos según score) y Coneja (apuesta con acumulación progresiva).',
