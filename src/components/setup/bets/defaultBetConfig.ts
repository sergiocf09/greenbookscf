import { BetConfig, DEFAULT_STABLEFORD_POINTS, SkinsGrupalBetConfig, WolfScoringMode, WolfTiming } from '@/types/golf';
...
export const defaultBetConfig: BetConfig = {
  ...
  matchPlay: { enabled: false, amount: 50 },
  bloques: { enabled: false, holesPerBlock: 3, amountPerBlock: 100, carryOverOnTie: true },
  ...
  medalGeneral: { enabled: false, amount: 100, playerHandicaps: [], segmentMode: 'total', handicapMode: 'individual' },
