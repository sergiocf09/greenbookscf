        ...
        <CardContent>
          <Tabs defaultValue="signin" className="w-full">
            <TabsList className="grid w-full grid-cols-2">
              ...
              <TabsTrigger value="signup">{trs("Registrarse")}</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="signin">
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={isLoading}>
                  {isLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : trs("Iniciar Sesión")}
                </Button>
                <button
                  type="button"
                ...
                {needsConfirmation && (
                  <div className="rounded-md border border-primary/30 bg-primary/5 p-3 space-y-2">
                    ...
                    >
                      {isResending ? <Loader2 className="h-4 w-4 animate-spin" /> : trs("Reenviar correo de confirmación")}
                    </Button>
                  </div>
                )}
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={isLoading || !acceptedTerms}>
                  {isLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : trs("Crear Cuenta")}
                </Button>
