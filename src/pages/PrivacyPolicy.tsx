  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <h1 className="text-2xl font-bold text-center mb-1">{trs("Política de Privacidad")}</h1>
        <p className="text-xs text-muted-foreground text-center mb-8">{trs("Última actualización: Abril 2026")}</p>

        <h2 className="text-lg font-semibold mt-6 mb-2">{trs("1. Responsable del tratamiento de datos")}</h2>
        ...
        <h2 className="text-lg font-semibold mt-6 mb-2">{trs("3. Finalidad del tratamiento")}</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
          {trs("Los datos se utilizan exclusivamente para: gestión de tu cuenta de usuario, funcionamiento del servicio (registro de rondas y apuestas), soporte técnico, y comunicaciones de servicio. No utilizamos tus datos para fines de marketing sin tu consentimiento explícito.")}
        </p>

        <h2 className="text-lg font-semibold mt-6 mb-2">{trs("4. No venta de datos")}</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
          {trs("GreenBook no vende, arrienda, ni comparte datos personales con terceros para fines comerciales propios de dichos terceros.")}
        </p>

        <h2 className="text-lg font-semibold mt-6 mb-2">{trs("5. Proveedores de servicio (subencargados)")}</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-lg font-semibold mt-6 mb-2">{trs("7. Eliminación de cuenta y datos")}</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
          {trs("Al eliminar tu cuenta, tus credenciales de acceso (email y contraseña) son eliminadas permanentemente de forma inmediata. El historial de rondas y apuestas en las que participaste se conserva de forma anonimizada — tu nombre es reemplazado por \"Usuario eliminado\" — para preservar el historial de los demás jugadores involucrados. Tus membresías activas en rankings son eliminadas.")}
        </p>

        <h2 className="text-lg font-semibold mt-6 mb-2">{trs("8. Retención de datos")}</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-lg font-semibold mt-6 mb-2">{trs("10. Cambios a esta política")}</h2>
        <p className="text-sm text-muted-foreground leading-relaxed">
